...
```
## [1] "/scratch/331112.1.ood/RtmpVibJQP/file2ea7df13899d71"
```
...
``` r
train_test_wrapper <- function(meta_trn, meta_tst, methodName="ElasticNet", do_plot=TRUE, seed=42, graphTitle="", stratifying=FALSE, applyBiasCorrection=FALSE) {
...
``` r
standardizedModelBuilding <- function(layersVector, cancerName="HNSC", splitSize=0.999, testOnCompleteData=FALSE, graphTitle="", methodNames=c("ElasticNet"), seed=43, columnsToKeep=c("Age", "gender", "race", "HPV.status", "submitter_id"), stratifying=FALSE, existingExperimentsList=NULL, iterationCount=NULL, applyBiasCorrection=FALSE, combiningNormal=FALSE, scaleByNormal=FALSE, significanceCutoff=0.025){
  if (splitSize > 0.98){ testOnCompleteData=TRUE}
