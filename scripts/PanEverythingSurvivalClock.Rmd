...
# Current test
modelOutput <- standardizedModelBuilding(c("RNAseq"), cancerName="BRCA", methodNames=c("glmnet"), splitSize=1, seed=43, existingExperimentsList=existingExperimentList, iterationCount=2, applyBiasCorrection=FALSE, combiningNormal=FALSE)
...
write.csv(modelOutput$ModelBuilding$combinedWeights$meanSums, outFile, row.names = FALSE)
```
