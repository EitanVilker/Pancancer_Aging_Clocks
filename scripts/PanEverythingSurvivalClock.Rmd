...
# Current test
modelOutput <- standardizedModelBuilding(c("RNAseq"), cancerName="BRCA", methodNames=c("ridge"), splitSize=1, seed=43, existingExperimentsList=existingExperimentList, iterationCount=10, applyBiasCorrection=FALSE, combiningNormal=FALSE)
...
outFile <- "/restricted/projectnb/agedisease/projects/pancancer_aging_clocks/results/CoefficientFrames/BRCA/RNAseqBRCA_model_10CV.rds"
write.csv(modelOutput$ModelBuilding, outFile, row.names = FALSE)
```
