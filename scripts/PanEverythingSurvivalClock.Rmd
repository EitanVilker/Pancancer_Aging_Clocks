...
layers <- c("RNAseq")
iterationCount <- 1
modelOutput <- standardizedModelBuilding(layers, cancerName=cancerType, methodNames=c("glmnet"), splitSize=1, seed=43, existingExperimentsList=existingExperimentList, iterationCount=iterationCount, applyBiasCorrection=FALSE, combiningNormal=FALSE, scaleByNormal=FALSE)
...
additionalDescriptor <- "Ridge_Scaled_10CV"
...
process_gene_weights(cancer_type, weights_file=coefficientPath, output_dir=output_dir)
