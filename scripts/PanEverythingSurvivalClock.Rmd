...
# Holdouts
modelOutput <- standardizedModelBuilding(c("miRNA", "RPPA"), cancerName="HNSC", methodNames=c("glmnet"), splitSize=0.8, seed=43, existingExperimentsList=existingExperimentList)
