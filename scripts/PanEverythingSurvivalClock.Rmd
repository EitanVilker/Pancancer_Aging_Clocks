...
# Current test
modelOutput <- standardizedModelBuilding(c("RPPA"), cancerName="KIRC", methodNames=c("glmnet"), splitSize=1, seed=43, existingExperimentsList=existingExperimentList, iterationCount=1, applyBiasCorrection=FALSE, combiningNormal=FALSE)
