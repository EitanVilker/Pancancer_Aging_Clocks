...
# Current test
modelOutput <- standardizedModelBuilding(c("RNAseq"), cancerName="BRCA", methodNames=c("glmnet"), splitSize=1, seed=43, existingExperimentsList=existingExperimentList, iterationCount=3, applyBiasCorrection=FALSE, combiningNormal=FALSE)
