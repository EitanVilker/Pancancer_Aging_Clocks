...
# Current test
modelOutput <- standardizedModelBuilding(c("RNAseq"), cancerName="KIRC", methodNames=c("glmnet"), splitSize=1, seed=43, existingExperimentsList=existingExperimentList, iterationCount=10, applyBiasCorrection=FALSE, combiningNormal=FALSE)
