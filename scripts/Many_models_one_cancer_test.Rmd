...
coef_list <- list()
  ...
  # non_interaction_table <- data.frame(
  #   test_name = character(),
  #   coef = numeric(),
  #   exp_coef = numeric(),
  #   se = numeric(),
  #   concordance = numeric(),
  #   likelihood_ratio_stat = numeric(),
  #   likelihood_ratio_df = numeric(),
  #   likelihood_ratio_p = numeric(),
  #   p_value_delta_age = numeric(),
  #   stringsAsFactors = FALSE
  # )
  # 
  # interaction_table <- non_interaction_table  # Same structure as above


#{r Running All 8 Models and Stats, results='asis', echo=FALSE}
#cat(paste("##", cancer_type, "\n"))
...
all_tables <- lapply(names(coef_list), function(placeholder) {
  div(
    h3(placeholder),
    reactable(coef_list[[placeholder]])
  )
})
